        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                if (RunEnvironment.IsTestEnvironment)
                    connectionString = "server=localhost;user id=root;database=logopedia_teszt";
                else
                    connectionString = ConfigurationManager.ConnectionStrings["LogopediaDB"].ConnectionString;
